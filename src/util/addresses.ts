...
import { FACTORY_ADDRESS } from '@juiceswapxyz/v3-sdk';
...
export const WETH9: {
  ...
  [ChainId.CITREA_TESTNET]: WETH9_HELPER[ChainId.CITREA_TESTNET]!,
  [ChainId.CITREA_MAINNET]: WETH9_HELPER[ChainId.CITREA_MAINNET]!,
};
